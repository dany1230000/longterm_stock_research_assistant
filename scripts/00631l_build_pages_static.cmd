...
call scripts\00631l_export_static_data.cmd --update --strict --max-coverage-age-days 7 --min-etf-catalog-row-count 100 --multi-etf-codes all-local --output-dir web\00631l-static-data --summary-only
if errorlevel 1 exit /b %ERRORLEVEL%
