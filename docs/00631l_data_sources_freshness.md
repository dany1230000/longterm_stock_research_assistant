...
| TX quote | TAIFEX MIS quote stream through backend | Backend cache defaults to 15 seconds | Provides TXF-P quote, weighted-index reference, and basis when TAIFEX is active. Off-hours can be unavailable or stale. |
