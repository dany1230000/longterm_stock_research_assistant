...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.97-public-persistence-sample-guard")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.97-public-persistence-sample-guard")
