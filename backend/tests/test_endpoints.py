...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.4-symbol-search-capability-labels")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.4-symbol-search-capability-labels")
