...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.91-public-marker-maintenance-summary")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.91-public-marker-maintenance-summary")
