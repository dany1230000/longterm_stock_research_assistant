...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.15-symbol-search-history-filter")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.15-symbol-search-history-filter")
