...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.2-etf-comparison-status-cleanup")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.2-etf-comparison-status-cleanup")
