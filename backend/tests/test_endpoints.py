...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.75-public-batch-regression-guidance")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.75-public-batch-regression-guidance")
