...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.5-history-backtest-range-context")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.5-history-backtest-range-context")
