...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.21-custom-etf-comparison-basket")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.21-custom-etf-comparison-basket")
