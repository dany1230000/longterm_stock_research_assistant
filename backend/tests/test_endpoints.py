...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.11-symbol-search-history-coverage")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.11-symbol-search-history-coverage")
