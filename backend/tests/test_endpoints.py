...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.17-overview-chart-date-inspector")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.17-overview-chart-date-inspector")
