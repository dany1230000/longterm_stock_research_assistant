...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.10-overview-data-readiness-ribbon")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.10-overview-data-readiness-ribbon")
