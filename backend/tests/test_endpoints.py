...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.16-selected-etf-readiness-banner")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.16-selected-etf-readiness-banner")
