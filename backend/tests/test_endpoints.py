...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.80-persistence-first-maintenance")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.80-persistence-first-maintenance")
