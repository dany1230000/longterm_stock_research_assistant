...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.98-public-persistence-fail-classification")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.98-public-persistence-fail-classification")
