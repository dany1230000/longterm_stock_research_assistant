...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.68-public-batch-offset-guidance")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.68-public-batch-offset-guidance")
