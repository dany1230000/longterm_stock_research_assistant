...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.24-ai-daily-interpretation-matrix")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.24-ai-daily-interpretation-matrix")
