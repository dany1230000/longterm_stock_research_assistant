...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.69-public-batch-timeout-payload")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.69-public-batch-timeout-payload")
