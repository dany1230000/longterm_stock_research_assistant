...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "5.13-selected-history-split-status")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v5.13-selected-history-split-status")
