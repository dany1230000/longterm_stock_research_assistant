...
class EndpointTests(unittest.TestCase):
    ...
    def test_health(self) -> None:
        ...
        self.assertEqual(payload["appVersion"], "4.84-public-batch-test-state-isolation")
        self.assertEqual(payload["release"]["tag"], "00631l-lab-v4.84-public-batch-test-state-isolation")
