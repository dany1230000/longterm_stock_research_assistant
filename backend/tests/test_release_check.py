...
class ReleaseCheckTests(unittest.TestCase):
    ...
    def test_release_check_runs_public_post_deploy_refresh_dry_run(self) -> None:
        source = (ROOT / "backend" / "scripts" / "release_check_00631l.py").read_text(
            encoding="utf-8",
        )

        self.assertIn('"public_post_deploy_refresh_dry_run"', source)
        self.assertIn("scripts\\\\00631l_public_post_deploy_refresh.cmd", source)
