...
def main() -> int:
    ...
    steps = [
        ...
        _run_command(
            "public_post_deploy_refresh_dry_run",
            ["cmd", "/c", "scripts\\00631l_public_post_deploy_refresh.cmd", "--dry-run"],
        ),
        _run_command(
        ...
        _run_command(
            "tpex_etf_price_history_status",
            [
                "cmd",
                "/c",
                "scripts\\00631l_import_tpex_etf_price_history.cmd",
                "--status-only",
                "--summary-only",
            ],
        ),
...
def _required_files_check() -> dict[str, Any]:
    required_files = [
        ...
        "docs/00631l_v5_69_catalog_complete_static_index.md",
        "docs/00631l_v5_70_broad_etf_price_seed.md",
        ...
        "docs/00631l_v5_88_pages_fast_static_build.md",
        ...
        "docs/00631l_v6_7_public_gap_release_guard.md",
        ...
        "docs/00631l_v6_19_pages_deploy_status_alignment.md",
        "docs/00631l_v6_20_symbol_search_ranking.md",
        "docs/00631l_v6_21_comparison_readiness.md",
        ...
        "docs/00631l_v6_26_overview_date_axis_fit.md",
        "docs/00631l_v6_27_overview_core_strip.md",
        ...
        "docs/00631l_v9_53_post_deploy_freshness_wait.md",
        "docs/00631l_v9_54_deploy_warning_classification.md",
        ...
        "backend/app/tpex_etf_price_history.py",
        ...
        "backend/scripts/check_public_static_data_00631l.py",
        "backend/scripts/guard_static_public_regression_00631l.py",
        ...
        "backend/scripts/public_post_deploy_refresh_00631l.py",
        ...
        "backend/scripts/import_tpex_etf_price_history.py",
        "backend/scripts/restore_public_00631l_price_history.py",
        "backend/scripts/restore_public_etf_price_history.py",
        "backend/scripts/restore_public_etf_attempts.py",
        ...
        "scripts/00631l_restore_public_price_history.cmd",
